...
# Implement SQL generation tool: generate SQL via Gemini, sanitize SQL, and execute against DB
async def execute_health_sql_tool(*, user_id: str, question: str, tz_name: str) -> dict:
    ...
    fast_client = get_openai_compatible_client("gemini")
