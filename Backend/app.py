...
from Backend.Models.requests import SimpleChatRequest, ChatWithCIRequest, CodeInterpreterDecisionRequest
...
async def should_use_code_interpreter(_: CodeInterpreterDecisionRequest, req: Request):
    verify_clerk_jwt(req)
    return {"use_code_interpreter": True}
